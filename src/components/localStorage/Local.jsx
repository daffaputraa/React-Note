...
const Local = () => {
  ...
  const dataProduk = [{id : 1, title : "Ice Cream"}, {id : 2, title : "Soda"}]
  ...
  const addData = (e) => {
    ...
    localStorage.setItem('addData', JSON.stringify([...produk, {id : produk.length + 1, title : newData}]))
  }

  const delateData = (e) => {
    setProduk(produk.filter((ele, index)=> ele.id !== e))
    localStorage.setItem('addData', JSON.stringify(produk.filter((ele, index)=> ele.id !== e)))
  }
